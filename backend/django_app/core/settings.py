...
OCR_PDF_TEXT_MIN_CHARS = int(os.getenv("OCR_PDF_TEXT_MIN_CHARS", "80"))
OCR_PDF_MAX_PAGES = int(os.getenv("OCR_PDF_MAX_PAGES", "5"))
OCR_PDF_RASTER_DPI = int(os.getenv("OCR_PDF_RASTER_DPI", "200"))
OCR_IMAGE_MAX_DIM = int(os.getenv("OCR_IMAGE_MAX_DIM", "2200"))
OCR_IMAGE_MIN_DIM = int(os.getenv("OCR_IMAGE_MIN_DIM", "1200"))
OCR_IMAGE_CONTRAST = float(os.getenv("OCR_IMAGE_CONTRAST", "1.35"))
OCR_IMAGE_BINARIZE = os.getenv("OCR_IMAGE_BINARIZE", "true").lower() == "true"
OCR_IMAGE_THRESHOLD = int(os.getenv("OCR_IMAGE_THRESHOLD", "170"))
...
MEDICATION_VERIFY_PROPERTY_LOOKUP_LIMIT = int(os.getenv("MEDICATION_VERIFY_PROPERTY_LOOKUP_LIMIT", "3"))
MEDICATION_VERIFY_MIN_MATCH_SCORE = int(os.getenv("MEDICATION_VERIFY_MIN_MATCH_SCORE", "72"))
MEDICATION_VERIFY_MIN_CONTEXT_SCORE = int(os.getenv("MEDICATION_VERIFY_MIN_CONTEXT_SCORE", "0"))
MEDICATION_VERIFY_FASTPATH_MIN_MATCH_SCORE = int(os.getenv("MEDICATION_VERIFY_FASTPATH_MIN_MATCH_SCORE", "90"))
MEDICATION_VERIFY_FASTPATH_MIN_CONTEXT_SCORE = int(os.getenv("MEDICATION_VERIFY_FASTPATH_MIN_CONTEXT_SCORE", "25"))
MEDICATION_VERIFY_FASTPATH_MIN_COMBINED_LEAD = int(os.getenv("MEDICATION_VERIFY_FASTPATH_MIN_COMBINED_LEAD", "10"))
