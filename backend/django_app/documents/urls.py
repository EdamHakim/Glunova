...
from .views import DocumentDetailView, DocumentDownloadView, DocumentListCreateView, MeView, DebugGeminiView
...
urlpatterns = [
    ...
    path("debug_gemini", DebugGeminiView.as_view(), name="debug-gemini"),
]
